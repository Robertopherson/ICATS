...
OPTIONAL_INPUT_KEYS = [
    ...
    ("output-frame", "Output/reporting frame convention: internal or incoming-k-plus-z. The latter applies Rx(pi) before reporting/export."),
    ...
    ("relative-velocity", "Direct relative speed in m/s; optional second value is FWHM in m/s."),
    ("collision-energy", "Direct fixed collision energy in eV."),
    ("incoming-p0", "Direct fixed relative momentum in atomic units."),
    ("incoming-k", "Direct fixed incoming wave number in bohr^-1."),
    ("workers", "Number of parallel workers."),
    ("seed", "Random seed."),
    ("seed-mode", "Seed strategy: fixed, time, per-worker."),
    ("run-mode", "Run behavior: fresh, continue, or rebuild-wang. Existing wang.pkl is reused only if compatible."),
    ...
    ("audit-initial-vib-tol", "Optional vibrational Q/P RMS-per-component tolerance; 0 records diagnostics without failing."),
    ("audit-initial-velocity-tol", "Optional relative-velocity tolerance in m/s."),
    ...
    ("continue", "Legacy restart flag using existing worker pickle files (True/False)."),
    ...
    ("orientation-mode", "Molecule orientation mode: isotropic, fixed alpha beta gamma, or pdf file.py function pars."),
    ("orientation-frame", "Frame for molecule orientation PDF; currently scattering."),
    ("orientation-thin", "MC thinning between saved molecule orientation-PDF samples."),
    ("ordist", "Legacy orientation distribution alias; prefer orientation-mode."),
