...
For the sampled orbital histograms, the most useful quick checks are:
...
python rd_tutorial_input/histograms/sampled/system/hist_sam_sys_orb_sj.py \
  --no-show --outfile rd_tutorial_input/histograms/plots/sampled/hist_sam_sys_orb_sj
python rd_tutorial_input/histograms/sampled/system/hist_sam_sys_orb_sjab.py \
  --no-show --outfile rd_tutorial_input/histograms/plots/sampled/hist_sam_sys_orb_sjab
```
